...
export default function Squares() {
  ...
  const [ squares, setSquares ] = useState(listOfSquareIds); //! this holds the array of active square id's
  ...
  const markActive = id => {
    ...
    //? we are making a ternary that will tell us to either display or not display?
